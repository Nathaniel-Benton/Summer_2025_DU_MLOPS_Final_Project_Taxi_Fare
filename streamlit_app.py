...
with st.form("prediction_form"):
    ...
    with col1:
        trip_distance = st.number_input(
            "Trip Distance (miles)", min_value=0.0, value=3.0, step=0.1
        )
    ...
    with col2:
        pu_location_id = st.number_input(
            "Pickup Location ID", min_value=1, max_value=265, value=142, step=1
        )
        do_location_id = st.number_input(
            "Dropoff Location ID", min_value=1, max_value=265, value=236, step=1
        )
